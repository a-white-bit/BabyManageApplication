...
public class CampManagementApplication {
    ...
    private static void displayStudentView() {
        ...
        while (flag) {
            ...
            switch (input) {
                ...
                case 3 -> studentStateInquire(); // 수강생 목록 조회
    ...
    private static void createStudent() {
        ...
        System.out.print("수강생 상태 입력 (1 : 좋음  2 : 보통  3 : 나쁨 ) : ");
    ...
    // 상태별 수강생 목록 조회
    private static void studentStateInquire() {
...
//        System.out.println("\n수강생 목록 조회 성공!");
    ...
    private static String getStudentState() {
        System.out.print("\n관리할 수강생의 상태를 번호로 입력하시오 (1 : 좋음  2 : 보통  3 : 나쁨  :  )"); //관리할 학생의 기분?
        return sc.next();
    }
    ...
    private static void inquireStudentState() {
        String studentId = getStudentId(); // 관리할 수강생 고유 번호
        // 기능 구현 (조회할 특정 과목)
        System.out.println("상태별 학생의 목록을 조회합니다...");
        // 기능 구현
        System.out.println("\n등급 조회 성공!");
    }
